package com.hao.lib.view.StackLayout;
...
import com.hao.lib.view.StackLayout.widget.ScrollManager;
...
//                        Log.d(TAG, "onViewReleased: remove" + ViewHolder.getPosition(releasedChild));
    ...
    // ------ OnSwipeListener ------
    @NonNull
    private OnSwipeListener mOnSwipeListener = OnSwipeListener.EMPTY;
