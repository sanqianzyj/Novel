...
public class CommonSharedPreferences {
    ...
    public static final String FILE_NAME = "APP_PARAMS";

    public static void put(String key, Object value) {

        SharedPreferences sp = MI2App.getInstance().getSharedPreferences(FILE_NAME, MODE_MULTI_PROCESS);
    ...
    public static Object get(String key, Object defaultValue) {
        SharedPreferences sp = MI2App.getInstance().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
